...
namespace Modbus
{
    ...
    public class ModbusTCPMaster
    {
        ...
        public const ushort ReadCoilsFucID = 1;
        public const ushort ReadDiscreteInputsFucID = 2;
        public const ushort ReadHoldingRegisterFucID = 3;
        public const ushort ReadInputRegisterFucID = 4;
        public const ushort WriteSingleCoilFucID = 5;
        public const ushort WriteMultipleCoilsFucID = 6;
        public const ushort WriteSingleRegisterFucID = 7;
        public const ushort WriteMultipleRegisterFucID = 8;
        ...
        public byte[] tcpAsyClBuffer = new byte[2048];
        ...
        public int ConnectTimeOutSec { get; set; } = 3000;
        ...
        public void connect(string ip, ushort port)
        {
            try
            {
                ...
                //tcpAsyCl.BeginConnect(new IPEndPoint(IPAddress.Parse(ip), port), CallBackMethod, tcpAsyCl);
                ...
                //tcpSynCl.BeginConnect(new IPEndPoint(IPAddress.Parse(ip), port), CallBackMethod, tcpSynCl);
                ...
                _connected = true;
                //if (TimeoutObject.WaitOne(ConnectTimeOutSec, false))
                //{
                //    if (_connected)
                //    {
                //        return;
                ...
                //    tcpAsyCl.Close();
                //    tcpSynCl.Close();
                //    throw new TimeoutException("连接从机超时！\r\n请检查硬件接线");
                //}
